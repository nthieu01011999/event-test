...
#include <vvtk_video.h>
     ...
     *
     * This structure contains information about an ROI, including a list of points,
     * point size, and a ratio used to determine motion events.
     */
    typedef struct
    {
        vvtk_point_t *point_list;
        int point_size;
        int ratio; // The threshold ratio that determined motion event
    } vvtk_roi_t;
