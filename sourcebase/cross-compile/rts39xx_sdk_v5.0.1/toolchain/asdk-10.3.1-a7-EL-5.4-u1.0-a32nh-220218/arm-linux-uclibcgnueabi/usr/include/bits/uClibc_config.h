...
#define __KERNEL_HEADERS__ "../kernel-arm"
...
#define __CROSS_COMPILER_PREFIX__ "arm-linux-uclibcgnueabi-"
#define __UCLIBC_EXTRA_CFLAGS__ " -mcpu=cortex-a7 -mfloat-abi=hard -mfpu=auto "
#undef __DODEBUG__
