/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/jenkins/sdlc/workspace/rsdk-release-flow/build/build-asdk-10-uclibc-3678/gcc-10/gcc/config/arm/arm.md'.  */
...
extern int mve_vldrw_immediate (rtx, machine_mode);
...
{
  if (c >= CONSTRAINT_Rh && c <= CONSTRAINT_US)
    return;
