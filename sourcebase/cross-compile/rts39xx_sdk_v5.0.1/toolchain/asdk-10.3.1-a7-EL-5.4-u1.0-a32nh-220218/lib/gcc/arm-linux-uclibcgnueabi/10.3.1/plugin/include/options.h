...
enum opt_code
{
  ...
  OPT_Tbss_ = 378,                           /* -Tbss= */
  OPT_Tdata = 379,                           /* -Tdata */
  OPT_Tdata_ = 380,                          /* -Tdata= */
  OPT_Ttext = 381,                           /* -Ttext */
  OPT_Ttext_ = 382,                          /* -Ttext= */
  OPT_U = 383,                               /* -U */
  /* OPT_W = 384, */                         /* -W */
  OPT_Wa_ = 385,                             /* -Wa, */
  OPT_Wabi = 386,                            /* -Wabi */
  OPT_Wabi_tag = 387,                        /* -Wabi-tag */
  OPT_Wabi_ = 388,                           /* -Wabi= */
  OPT_Wabsolute_value = 389,                 /* -Wabsolute-value */
  OPT_Waddress = 390,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 391,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 392,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 393,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 394,                       /* -Waliasing */
  OPT_Walign_commons = 395,                  /* -Walign-commons */
  /* OPT_Waligned_new = 396, */              /* -Waligned-new */
  OPT_Waligned_new_ = 397,                   /* -Waligned-new= */
  OPT_Wall = 398,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 399,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 400,                     /* -Walloc-zero */
  OPT_Walloca = 401,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 402,            /* -Walloca-larger-than= */
  OPT_Wampersand = 403,                      /* -Wampersand */
  OPT_Wanalyzer_double_fclose = 404,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 405,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 406,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_file_leak = 407,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 408,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_malloc_leak = 409,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_null_argument = 410,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 411,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_possible_null_argument = 412,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 413,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_stale_setjmp_buffer = 414,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_tainted_array_index = 415,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_too_complex = 416,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 417,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 418,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 419,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wargument_mismatch = 420,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 421,               /* -Warith-conversion */
  OPT_Warray_bounds = 422,                   /* -Warray-bounds */
  OPT_Warray_bounds_ = 423,                  /* -Warray-bounds= */
  OPT_Warray_temporaries = 424,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 425,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 426, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 427,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 428,              /* -Wattribute-warning */
  OPT_Wattributes = 429,                     /* -Wattributes */
  OPT_Wbad_function_cast = 430,              /* -Wbad-function-cast */
  OPT_Wbool_compare = 431,                   /* -Wbool-compare */
  OPT_Wbool_operation = 432,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 433,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 434,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 435,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 436, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 437,                   /* -Wc++11-compat */
  OPT_Wc__14_compat = 438,                   /* -Wc++14-compat */
  OPT_Wc__17_compat = 439,                   /* -Wc++17-compat */
  /* OPT_Wc__1z_compat = 440, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 441,                   /* -Wc++20-compat */
  /* OPT_Wc__2a_compat = 442, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 443,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 444,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 445,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 446,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 447,                 /* -Wcannot-profile */
  OPT_Wcast_align = 448,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 449,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 450,             /* -Wcast-function-type */
  OPT_Wcast_qual = 451,                      /* -Wcast-qual */
  OPT_Wcast_result = 452,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 453, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 454,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 455,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 456,           /* -Wcharacter-truncation */
  OPT_Wchkp = 457,                           /* -Wchkp */
  OPT_Wclass_conversion = 458,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 459,                /* -Wclass-memaccess */
  OPT_Wclobbered = 460,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 461,                /* -Wcomma-subscript */
  OPT_Wcomment = 462,                        /* -Wcomment */
  /* OPT_Wcomments = 463, */                 /* -Wcomments */
  OPT_Wcompare_reals = 464,                  /* -Wcompare-reals */
  OPT_Wconditionally_supported = 465,        /* -Wconditionally-supported */
  OPT_Wconversion = 466,                     /* -Wconversion */
  OPT_Wconversion_extra = 467,               /* -Wconversion-extra */
  OPT_Wconversion_null = 468,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 469,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 470,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 471,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 472,                  /* -Wdangling-else */
  OPT_Wdate_time = 473,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 474,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 475,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 476,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 477,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 478,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 479,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 480,        /* -Wdeprecated-declarations */
  OPT_Wdesignated_init = 481,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 482,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 483,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 484,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 485,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 486,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 487,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 488,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 489,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 490,                /* -Wduplicated-cond */
  OPT_Weffc__ = 491,                         /* -Weffc++ */
  OPT_Wempty_body = 492,                     /* -Wempty-body */
  OPT_Wendif_labels = 493,                   /* -Wendif-labels */
  OPT_Wenum_compare = 494,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 495,                /* -Wenum-conversion */
  OPT_Werror = 496,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 497, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 498,                         /* -Werror= */
  OPT_Wexpansion_to_defined = 499,           /* -Wexpansion-to-defined */
  OPT_Wextra = 500,                          /* -Wextra */
  OPT_Wextra_semi = 501,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 502,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 503,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 504,                    /* -Wfloat-equal */
  /* OPT_Wformat = 505, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 506,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 507,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 508,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 509,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 510, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 511,               /* -Wformat-overflow= */
  OPT_Wformat_security = 512,                /* -Wformat-security */
  OPT_Wformat_signedness = 513,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 514, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 515,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 516,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 517,             /* -Wformat-zero-length */
  OPT_Wformat_ = 518,                        /* -Wformat= */
  OPT_Wframe_address = 519,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 520,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 521,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 522,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 523,           /* -Wfunction-elimination */
  OPT_Whsa = 524,                            /* -Whsa */
  OPT_Wif_not_aligned = 525,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 526,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 527,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 528,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 529, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 530,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 531,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 532,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 533,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 534,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 535, */                   /* -Wimport */
  OPT_Winaccessible_base = 536,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 537,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 538,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 539,             /* -Winit-list-lifetime */
  OPT_Winit_self = 540,                      /* -Winit-self */
  OPT_Winline = 541,                         /* -Winline */
  OPT_Wint_conversion = 542,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 543,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 544,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 545,               /* -Winteger-division */
  OPT_Wintrinsic_shadow = 546,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 547,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 548,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 549,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 550,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 551,               /* -Wjump-misses-init */
  OPT_Wl_ = 552,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 553, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 554,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 555,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 556,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 557,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 558,                     /* -Wlogical-op */
  OPT_Wlong_long = 559,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 560,              /* -Wlto-type-mismatch */
  OPT_Wmain = 561,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 562,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 563,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 564,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 565,         /* -Wmisleading-indentation */
  OPT_Wmismatched_tags = 566,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 567,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 568,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 569,           /* -Wmissing-declarations */
  OPT_Wmissing_delay_slot = 570,             /* -Wmissing-delay-slot */
  ...
  OPT_Wpossible_load_use = 626,              /* -Wpossible-load-use */
  OPT_Wpragmas = 627,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 628,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 629,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 630,                       /* -Wprotocol */
  OPT_Wpsabi = 631,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 632,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 633,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 634,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 635,                /* -Wredundant-decls */
  OPT_Wredundant_move = 636,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 637,                 /* -Wredundant-tags */
  OPT_Wregister = 638,                       /* -Wregister */
  OPT_Wreorder = 639,                        /* -Wreorder */
  OPT_Wrestrict = 640,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 641,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 642,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 643,           /* -Wscalar-storage-order */
  OPT_Wselector = 644,                       /* -Wselector */
  OPT_Wsequence_point = 645,                 /* -Wsequence-point */
  OPT_Wshadow = 646,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 647, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 648,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 649, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 650,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 651, */            /* -Wshadow=global */
  OPT_Wshadow_local = 652,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 653,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 654,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 655,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 656, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 657,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 658,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 659,                /* -Wsign-conversion */
  OPT_Wsign_promo = 660,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 661,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 662,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 663,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 664,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 665,                    /* -Wspeculative */
  OPT_Wstack_protector = 666,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 667,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 668,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 669,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 670,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 671,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 672,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 673,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 674,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 675,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 676, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 677,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 678,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 679,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 680,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 681,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 682,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 683,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 684,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 685,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 686,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 687,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 688,               /* -Wsuggest-override */
  OPT_Wsurprising = 689,                     /* -Wsurprising */
  OPT_Wswitch = 690,                         /* -Wswitch */
  OPT_Wswitch_bool = 691,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 692,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 693,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 694,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 695,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 696,                      /* -Wsync-nand */
  OPT_Wsynth = 697,                          /* -Wsynth */
  OPT_Wsystem_headers = 698,                 /* -Wsystem-headers */
  OPT_Wtabs = 699,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 700,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 701,           /* -Wtautological-compare */
  OPT_Wtemplates = 702,                      /* -Wtemplates */
  OPT_Wterminate = 703,                      /* -Wterminate */
  OPT_Wtraditional = 704,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 705,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 706,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 707,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 708,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 709,            /* -Wundeclared-selector */
  OPT_Wundef = 710,                          /* -Wundef */
  OPT_Wundefined_do_loop = 711,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 712,                      /* -Wunderflow */
  OPT_Wuninitialized = 713,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 714,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 715, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 716, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 717,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 718,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 719,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 720,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 721, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 722,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 723,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 724,                /* -Wunused-function */
  OPT_Wunused_label = 725,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 726,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 727,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 728,               /* -Wunused-parameter */
  OPT_Wunused_result = 729,                  /* -Wunused-result */
  OPT_Wunused_value = 730,                   /* -Wunused-value */
  OPT_Wunused_variable = 731,                /* -Wunused-variable */
  OPT_Wuse_without_only = 732,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 733,                   /* -Wuseless-cast */
  OPT_Wvarargs = 734,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 735,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 736,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 737,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 738,            /* -Wvirtual-move-assign */
  OPT_Wvla = 739,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 740,               /* -Wvla-larger-than= */
  OPT_Wvolatile = 741,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 742,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 743,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 744,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 745,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 746,                       /* -Wzerotrip */
  OPT_X = 747,                               /* -X */
  OPT_Xassembler = 748,                      /* -Xassembler */
  OPT_Xf = 749,                              /* -Xf */
  OPT_Xlinker = 750,                         /* -Xlinker */
  OPT_Xpreprocessor = 751,                   /* -Xpreprocessor */
  OPT_Z = 752,                               /* -Z */
  OPT_ansi = 753,                            /* -ansi */
  OPT_aux_info = 754,                        /* -aux-info */
  /* OPT_aux_info_ = 755, */                 /* -aux-info= */
  OPT_auxbase = 756,                         /* -auxbase */
  OPT_auxbase_strip = 757,                   /* -auxbase-strip */
  OPT_c = 758,                               /* -c */
  OPT_callgraph = 759,                       /* -callgraph */
  OPT_coverage = 760,                        /* -coverage */
  OPT_cpp = 761,                             /* -cpp */
  OPT_cpp_ = 762,                            /* -cpp= */
  OPT_d = 763,                               /* -d */
  OPT_debuglib_ = 764,                       /* -debuglib= */
  OPT_defaultlib_ = 765,                     /* -defaultlib= */
  OPT_defined_only = 766,                    /* -defined-only */
  OPT_demangle = 767,                        /* -demangle */
  OPT_dstartfiles = 768,                     /* -dstartfiles */
  OPT_dump_body_ = 769,                      /* -dump-body= */
  OPT_dump_level_ = 770,                     /* -dump-level= */
  OPT_dumpbase = 771,                        /* -dumpbase */
  OPT_dumpdir = 772,                         /* -dumpdir */
  OPT_dumpfullversion = 773,                 /* -dumpfullversion */
  OPT_dumpmachine = 774,                     /* -dumpmachine */
  OPT_dumpspecs = 775,                       /* -dumpspecs */
  OPT_dumpversion = 776,                     /* -dumpversion */
  OPT_e = 777,                               /* -e */
  OPT_export_dynamic = 778,                  /* -export-dynamic */
  OPT_fPIC = 779,                            /* -fPIC */
  OPT_fPIE = 780,                            /* -fPIE */
  OPT_fRTS_ = 781,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 782,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 783,                   /* -fabi-version= */
  OPT_faccess_control = 784,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 785,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 786,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 787,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 788,                  /* -falign-commons */
  OPT_falign_functions = 789,                /* -falign-functions */
  OPT_falign_functions_ = 790,               /* -falign-functions= */
  OPT_falign_jumps = 791,                    /* -falign-jumps */
  OPT_falign_jumps_ = 792,                   /* -falign-jumps= */
  OPT_falign_labels = 793,                   /* -falign-labels */
  OPT_falign_labels_ = 794,                  /* -falign-labels= */
  OPT_falign_loops = 795,                    /* -falign-loops */
  OPT_falign_loops_ = 796,                   /* -falign-loops= */
  /* OPT_faligned_new = 797, */              /* -faligned-new */
  OPT_faligned_new_ = 798,                   /* -faligned-new= */
  OPT_fall_instantiations = 799,             /* -fall-instantiations */
  OPT_fall_intrinsics = 800,                 /* -fall-intrinsics */
  OPT_fall_virtual = 801,                    /* -fall-virtual */
  OPT_fallocation_dce = 802,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 803,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 804,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 805,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 806,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 807,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 808,         /* -falt-external-templates */
  OPT_fanalyzer = 809,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 810,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 811,              /* -fanalyzer-checker= */
  OPT_fanalyzer_fine_grained = 812,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 813,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 814,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 815,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 816,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 817,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 818, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 819,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 820, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 821, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 822, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 823, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 824,            /* -fasan-shadow-offset= */
  OPT_fasm = 825,                            /* -fasm */
  OPT_fassert = 826,                         /* -fassert */
  OPT_fassociative_math = 827,               /* -fassociative-math */
  OPT_fassume_phsa = 828,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 829,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 830,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 831,                   /* -fauto-profile */
  OPT_fauto_profile_ = 832,                  /* -fauto-profile= */
  OPT_fautomatic = 833,                      /* -fautomatic */
  OPT_fbackslash = 834,                      /* -fbackslash */
  OPT_fbacktrace = 835,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 836,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 837,                   /* -fbounds-check */
  OPT_fbounds_check_ = 838,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 839,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 840,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 841, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 842, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 843, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 844,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 845,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 846,                        /* -fbuiltin */
  OPT_fbuiltin_ = 847,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 848,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 849,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 850,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 851,                    /* -fcall-saved- */
  OPT_fcall_used_ = 852,                     /* -fcall-used- */
  OPT_fcaller_saves = 853,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 854,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 855,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 856,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 857, */            /* -fcf-protection */
  OPT_fcf_protection_ = 858,                 /* -fcf-protection= */
  OPT_fchar8_t = 859,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 860,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 861, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 862,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 863,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 864,                         /* -fcheck= */
  OPT_fchecking = 865,                       /* -fchecking */
  OPT_fchecking_ = 866,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 867,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 868,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 869,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 870,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 871,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 872,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 873,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 874,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 875, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 876,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 877,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 878,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 879, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 880,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 881,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 882,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 883,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 884,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 885, */                 /* -fcilkplus */
  OPT_fcoarray_ = 886,                       /* -fcoarray= */
  OPT_fcode_hoisting = 887,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 888,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 889,                         /* -fcommon */
  OPT_fcompare_debug = 890,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 891,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 892,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 893,                   /* -fcompare-elim */
  OPT_fconcepts = 894,                       /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 895,    /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 896,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 897,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 898, */           /* -fconserve-space */
  OPT_fconserve_stack = 899,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 900,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 901,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 902,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 903,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 904,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 905,                       /* -fconvert= */
  OPT_fcoroutines = 906,                     /* -fcoroutines */
  OPT_fcprop_registers = 907,                /* -fcprop-registers */
  OPT_fcray_pointer = 908,                   /* -fcray-pointer */
  OPT_fcrossjumping = 909,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 910,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 911, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 912,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 913,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 914,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 915,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 916,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 917,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 918,                       /* -fdbg-cnt= */
  OPT_fdce = 919,                            /* -fdce */
  OPT_fdebug = 920,                          /* -fdebug */
  OPT_fdebug_cpp = 921,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 922,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 923,            /* -fdebug-types-section */
  OPT_fdebug_ = 924,                         /* -fdebug= */
  OPT_fdec = 925,                            /* -fdec */
  OPT_fdec_blank_format_item = 926,          /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 927,           /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 928,            /* -fdec-format-defaults */
  OPT_fdec_include = 929,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 930,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 931,                       /* -fdec-math */
  OPT_fdec_static = 932,                     /* -fdec-static */
  OPT_fdec_structure = 933,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 934,              /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 935, */         /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 936,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 937, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 938,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 939,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 940,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 941,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 942,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 943,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 944,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 945,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 946,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 947,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 948,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 949, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 950,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 951,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 952,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 953,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 954,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 955,       /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_show_caret = 956,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 957,           /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 958,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 959,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 960,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 961,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 962,   /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 963, /* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 964,              /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 965,                /* -fdirectives-only */
  OPT_fdisable_ = 966,                       /* -fdisable- */
  OPT_fdoc = 967,                            /* -fdoc */
  OPT_fdoc_dir_ = 968,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 969,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 970,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 971,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 972,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 973,                       /* -fdruntime */
  OPT_fdse = 974,                            /* -fdse */
  OPT_fdump_ = 975,                          /* -fdump- */
  OPT_fdump_ada_spec = 976,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 977,             /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 978,                  /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 979,        /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 980,   /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 981,   /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 982, /* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 983, /* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_state_purge = 984,      /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 985,           /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 986,       /* -fdump-analyzer-supergraph */
  /* OPT_fdump_core = 987, */                /* -fdump-core */
  OPT_fdump_d_original = 988,                /* -fdump-d-original */
  OPT_fdump_final_insns = 989,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 990,              /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 991,            /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 992,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 993,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 994,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 995,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 996,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 997, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 998,                    /* -fdump-passes */
  OPT_fdump_scos = 999,                      /* -fdump-scos */
  OPT_fdump_unnumbered = 1000,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1001,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1002,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1003,                /* -fearly-inlining */
  OPT_felide_constructors = 1004,            /* -felide-constructors */
  OPT_felide_type = 1005,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1006, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1007,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1008,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1009,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1010,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1011,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1012,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1013,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1014,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1015,                /* -fenum-int-equiv */
  OPT_fexceptions = 1016,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1017,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1018,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1019,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1020,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1021,          /* -fextended-identifiers */
  OPT_fextern_tls_init = 1022,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1023,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1024,            /* -fexternal-templates */
  OPT_ff2c = 1025,                           /* -ff2c */
  OPT_ffast_math = 1026,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1027,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1028,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1029,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1030,              /* -ffinite-math-only */
  OPT_ffix_bdsl = 1031,                      /* -ffix-bdsl */
  OPT_ffixed_ = 1032,                        /* -ffixed- */
  OPT_ffixed_form = 1033,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1034,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1035,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1036,                   /* -ffloat-store */
  OPT_ffor_scope = 1037,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1038, */              /* -fforce-addr */
  OPT_fforward_propagate = 1039,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1040,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1041,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1042,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1043,                     /* -ffpe-trap= */
  OPT_ffree_form = 1044,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1045,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1046,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1047,                  /* -ffreestanding */
  OPT_ffriend_injection = 1048,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1049,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1050,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1051,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1052,             /* -ffunction-sections */
  OPT_fgcse = 1053,                          /* -fgcse */
  OPT_fgcse_after_reload = 1054,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1055,                      /* -fgcse-las */
  OPT_fgcse_lm = 1056,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1057,                       /* -fgcse-sm */
  OPT_fgimple = 1058,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1059,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1060,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1061,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1062,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1063,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1064,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1065,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1066,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1067,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1068,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1069,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1070,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1071,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1072,                      /* -fgo-dump- */
  OPT_fgo_optimize_ = 1073,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1074,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1075,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1076,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1077,                      /* -fgraphite */
  OPT_fgraphite_identity = 1078,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1079,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1080,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1081, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1082, */                    /* -fhelp */
  /* OPT_fhelp_ = 1083, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1084,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1085,                     /* -fhonor-std */
  OPT_fhosted = 1086,                        /* -fhosted */
  OPT_fhuge_objects = 1087,                  /* -fhuge-objects */
  OPT_fident = 1088,                         /* -fident */
  OPT_fif_conversion = 1089,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1090,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1091,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1092,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1093,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1094,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1095,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1096,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1097,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1098,               /* -finit-character= */
  OPT_finit_derived = 1099,                  /* -finit-derived */
  OPT_finit_integer_ = 1100,                 /* -finit-integer= */
  OPT_finit_local_zero = 1101,               /* -finit-local-zero */
  OPT_finit_logical_ = 1102,                 /* -finit-logical= */
  OPT_finit_real_ = 1103,                    /* -finit-real= */
  OPT_finline = 1104,                        /* -finline */
  OPT_finline_arg_packing = 1105,            /* -finline-arg-packing */
  OPT_finline_atomics = 1106,                /* -finline-atomics */
  OPT_finline_functions = 1107,              /* -finline-functions */
  OPT_finline_functions_called_once = 1108,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1109, */           /* -finline-limit- */
  OPT_finline_limit_ = 1110,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1111,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1112,        /* -finline-small-functions */
  OPT_finput_charset_ = 1113,                /* -finput-charset= */
  OPT_finstrument_functions = 1114,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1115,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1116,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1117,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1118,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1119,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1120,                    /* -finvariants */
  OPT_fipa_bit_cp = 1121,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1122,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1123, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1124,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1125,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1126,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1127,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1128, */        /* -fipa-matrix-reorg */
  OPT_fipa_profile = 1129,                   /* -fipa-profile */
  OPT_fipa_pta = 1130,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1131,                /* -fipa-pure-const */
  OPT_fipa_ra = 1132,                        /* -fipa-ra */
  OPT_fipa_reference = 1133,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1134,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1135,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1136,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1137, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1138,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1139,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1140,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1141,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1142,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1143,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1144,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1145,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1146,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1147,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1148,              /* -fivar-visibility= */
  OPT_fivopts = 1149,                        /* -fivopts */
  OPT_fjump_tables = 1150,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1151,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1152,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1153,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1154,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1155,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1156,                     /* -flabels-ok */
  OPT_flax_vector_conversions = 1157,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1158,            /* -fleading-underscore */
  OPT_flifetime_dse = 1159,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1160,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1161,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1162,                /* -flinker-output= */
  /* OPT_flive_patching = 1163, */           /* -flive-patching */
  OPT_flive_patching_ = 1164,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1165,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1166,                   /* -flocal-ivars */
  /* OPT_floop_block = 1167, */              /* -floop-block */
  /* OPT_floop_flatten = 1168, */            /* -floop-flatten */
  OPT_floop_interchange = 1169,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1170,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1171, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1172,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1173, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1174,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1175,                     /* -flra-remat */
  OPT_flto = 1176,                           /* -flto */
  OPT_flto_compression_level_ = 1177,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1178, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1179,                /* -flto-partition= */
  OPT_flto_report = 1180,                    /* -flto-report */
  OPT_flto_report_wpa = 1181,                /* -flto-report-wpa */
  OPT_flto_ = 1182,                          /* -flto= */
  OPT_fltrans = 1183,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1184,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1185,             /* -fmacro-prefix-map= */
  OPT_fmain = 1186,                          /* -fmain */
  OPT_fmath_errno = 1187,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1188,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1189,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1190,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1191,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1192,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1193,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1194,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1195,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1196,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1197,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1198,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1199,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1200,                  /* -fmodule-file= */
  OPT_fmodule_private = 1201,                /* -fmodule-private */
  OPT_fmoduleinfo = 1202,                    /* -fmoduleinfo */
  OPT_fmodulo_sched = 1203,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1204,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1205,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1206,                 /* -fms-extensions */
  OPT_fmudflap = 1207,                       /* -fmudflap */
  OPT_fmudflapir = 1208,                     /* -fmudflapir */
  OPT_fmudflapth = 1209,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1210,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1211,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1212,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1213,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1214,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1215,                 /* -fnil-receivers */
  OPT_fnon_call_exceptions = 1216,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1217,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1218,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1219,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1220,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1221,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1222,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1223,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1224,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1225,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1226,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1227,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1228,                  /* -foffload-abi= */
  OPT_foffload_ = 1229,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1230,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1231,                         /* -fonly= */
  OPT_fopenacc = 1232,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1233,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1234,                        /* -fopenmp */
  OPT_fopenmp_simd = 1235,                   /* -fopenmp-simd */
  OPT_foperator_names = 1236,                /* -foperator-names */
  OPT_fopt_info = 1237,                      /* -fopt-info */
  OPT_fopt_info_ = 1238,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1239, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1240,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1241,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1242, */          /* -foptional-diags */
  OPT_fpack_derived = 1243,                  /* -fpack-derived */
  OPT_fpack_struct = 1244,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1245,                  /* -fpack-struct= */
  OPT_fpad_source = 1246,                    /* -fpad-source */
  OPT_fpartial_inlining = 1247,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1248,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1249,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1250,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1251,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1252,                    /* -fpeel-loops */
  OPT_fpeephole = 1253,                      /* -fpeephole */
  OPT_fpeephole2 = 1254,                     /* -fpeephole2 */
  OPT_fpermissive = 1255,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1256,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1257,                           /* -fpic */
  OPT_fpie = 1258,                           /* -fpie */
  OPT_fplan9_extensions = 1259,              /* -fplan9-extensions */
  OPT_fplt = 1260,                           /* -fplt */
  OPT_fplugin_arg_ = 1261,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1262,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1263,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1264,                /* -fpostconditions */
  OPT_fpre_include_ = 1265,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1266,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1267,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1268,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1269,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1270,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1271,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1272,           /* -fprintf-return-value */
  OPT_fprofile = 1273,                       /* -fprofile */
  OPT_fprofile_abs_path = 1274,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1275,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1276,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1277,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1278,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1279,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1280,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1281,             /* -fprofile-generate= */
  OPT_fprofile_note_ = 1282,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1283,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_path_ = 1284,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1285,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1286,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1287,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1288,               /* -fprofile-update= */
  OPT_fprofile_use = 1289,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1290,                  /* -fprofile-use= */
  OPT_fprofile_values = 1291,                /* -fprofile-values */
  OPT_fprotect_parens = 1292,                /* -fprotect-parens */
  OPT_frandom_seed = 1293,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1294,                  /* -frandom-seed= */
  OPT_frange_check = 1295,                   /* -frange-check */
  OPT_freal_4_real_10 = 1296,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1297,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1298,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1299,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1300,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1301,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1302,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1303,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1304,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1305,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1306,               /* -frecord-marker=8 */
  OPT_frecursive = 1307,                     /* -frecursive */
  OPT_free = 1308,                           /* -free */
  OPT_freg_struct_return = 1309,             /* -freg-struct-return */
  /* OPT_fregmove = 1310, */                 /* -fregmove */
  OPT_frelease = 1311,                       /* -frelease */
  OPT_frename_registers = 1312,              /* -frename-registers */
  OPT_freorder_blocks = 1313,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1314,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1315,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1316,             /* -freorder-functions */
  OPT_frepack_arrays = 1317,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1318,          /* -freplace-objc-classes */
  OPT_frepo = 1319,                          /* -frepo */
  OPT_freport_bug = 1320,                    /* -freport-bug */
  OPT_frequire_return_statement = 1321,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1322,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1323, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1324,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1325,                   /* -fresolution= */
  OPT_frlxcov = 1326,                        /* -frlxcov */
  OPT_frounding_math = 1327,                 /* -frounding-math */
  OPT_frtti = 1328,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1329,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1330,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1331,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1332,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1333,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1334,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1335,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1336,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1337, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1338,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1339,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1340,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1341,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1342,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1343,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1344,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1345,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1346,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1347,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1348,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1349,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1350,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1351,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1352,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1353,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1354, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1355,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1356,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1357,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1358,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1359,               /* -fsection-anchors */
  /* OPT_fsee = 1360, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1361,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1362,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1363,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1364,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1365,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1366,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1367,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1368,                   /* -fshort-enums */
  OPT_fshort_wchar = 1369,                   /* -fshort-wchar */
  OPT_fshow_column = 1370,                   /* -fshow-column */
  OPT_fshrink_wrap = 1371,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1372,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1373,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1374,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1375,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1376,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1377,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1378,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1379,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1380,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1381,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1382,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1383,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1384,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1385,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1386,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1387,                      /* -fsquangle */
  OPT_fssa_backprop = 1388,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1389,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1390,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1391,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1392, */             /* -fstack-check */
  OPT_fstack_check_ = 1393,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1394,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1395,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1396,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1397,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1398,               /* -fstack-protector */
  OPT_fstack_protector_all = 1399,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1400,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1401,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1402,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1403,                   /* -fstack-usage */
  OPT_fstats = 1404,                         /* -fstats */
  OPT_fstdarg_opt = 1405,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1406,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1407, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1408,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1409,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1410,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1411,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1412,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1413, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1414,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1415,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1416,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1417,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1418,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1419, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1420,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1421, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1422,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1423, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1424,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1425,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1426,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1427,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1428,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1429,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1430,                   /* -ftime-report */
  OPT_ftime_report_details = 1431,           /* -ftime-report-details */
  OPT_ftls_model_ = 1432,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1433,              /* -ftoplevel-reorder */
  OPT_ftracer = 1434,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1435,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1436,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1437,                   /* -ftrampolines */
  OPT_ftransition_all = 1438,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1439,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1440,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1441,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1442,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1443,              /* -ftransition=field */
  OPT_ftransition_import = 1444,             /* -ftransition=import */
  OPT_ftransition_nogc = 1445,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1446,                /* -ftransition=tls */
  OPT_ftrapping_math = 1447,                 /* -ftrapping-math */
  OPT_ftrapv = 1448,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1449,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1450,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1451,                      /* -ftree-ccp */
  OPT_ftree_ch = 1452,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1453, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1454,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1455,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1456, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1457,                   /* -ftree-cselim */
  OPT_ftree_dce = 1458,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1459,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1460,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1461,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1462,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1463, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1464,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1465,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1466, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1467,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1468,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1469, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1470,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1471,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1472,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1473,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1474,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1475,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1476,                      /* -ftree-pre */
  OPT_ftree_pta = 1477,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1478,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1479, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1480,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1481,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1482,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1483,                     /* -ftree-slsr */
  OPT_ftree_sra = 1484,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1485, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1486, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1487,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1488,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1489,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1490, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1491,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1492, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1493,                      /* -ftree-vrp */
  OPT_ftword = 1494,                         /* -ftword */
  OPT_ftword_stack = 1495,                   /* -ftword-stack */
  OPT_funconstrained_commons = 1496,         /* -funconstrained-commons */
  OPT_funderscoring = 1497,                  /* -funderscoring */
  OPT_funit_at_a_time = 1498,                /* -funit-at-a-time */
  OPT_funittest = 1499,                      /* -funittest */
  OPT_funroll_all_loops = 1500,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1501,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1502,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1503, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1504,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1505,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1506,                 /* -funsigned-char */
  OPT_funswitch_loops = 1507,                /* -funswitch-loops */
  OPT_funwind_tables = 1508,                 /* -funwind-tables */
  OPT_fuse_balx = 1509,                      /* -fuse-balx */
  OPT_fuse_cxa_atexit = 1510,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1511,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1512,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1513,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1514,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1515,             /* -fuse-linker-plugin */
  OPT_fuse_tls = 1516,                       /* -fuse-tls */
  OPT_fuse_uls = 1517,                       /* -fuse-uls */
  OPT_fvar_tracking = 1518,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1519,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1520,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1521,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1522,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1523, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1524,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1525,                   /* -fverbose-asm */
  /* OPT_fversion = 1526, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1527,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1528,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1529,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1530,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1531,                   /* -fvisibility= */
  OPT_fvpt = 1532,                           /* -fvpt */
  OPT_fvtable_gc = 1533,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1534,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1535,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1536,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1537,                     /* -fvtv-debug */
  OPT_fweak = 1538,                          /* -fweak */
  OPT_fweb = 1539,                           /* -fweb */
  /* OPT_fwhole_file = 1540, */              /* -fwhole-file */
  OPT_fwhole_program = 1541,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1542,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1543,             /* -fworking-directory */
  OPT_fwpa = 1544,                           /* -fwpa */
  OPT_fwpa_ = 1545,                          /* -fwpa= */
  OPT_fwrapv = 1546,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1547,                 /* -fwrapv-pointer */
  OPT_fxref = 1548,                          /* -fxref */
  /* OPT_fzee = 1549, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1550,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1551,                     /* -fzero-link */
  OPT_g = 1552,                              /* -g */
  OPT_gant = 1553,                           /* -gant */
  OPT_gas_loc_support = 1554,                /* -gas-loc-support */
  OPT_gas_locview_support = 1555,            /* -gas-locview-support */
  OPT_gcoff = 1556,                          /* -gcoff */
  OPT_gcoff1 = 1557,                         /* -gcoff1 */
  OPT_gcoff2 = 1558,                         /* -gcoff2 */
  OPT_gcoff3 = 1559,                         /* -gcoff3 */
  OPT_gcolumn_info = 1560,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1561,                 /* -gdescribe-dies */
  OPT_gdwarf = 1562,                         /* -gdwarf */
  OPT_gdwarf_ = 1563,                        /* -gdwarf- */
  OPT_gen_decls = 1564,                      /* -gen-decls */
  OPT_ggdb = 1565,                           /* -ggdb */
  OPT_ggnu_pubnames = 1566,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1567,                   /* -gimple-stats */
  OPT_ginline_points = 1568,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1569, /* -ginternal-reset-location-views */
  OPT_gnat = 1570,                           /* -gnat */
  OPT_gnatO = 1571,                          /* -gnatO */
  OPT_gno_ = 1572,                           /* -gno- */
  OPT_gno_pubnames = 1573,                   /* -gno-pubnames */
  OPT_gpubnames = 1574,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1575,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1576,                   /* -gsplit-dwarf */
  OPT_gstabs = 1577,                         /* -gstabs */
  OPT_gstabs_ = 1578,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1579,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1580,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1581,                        /* -gtoggle */
  OPT_gvariable_location_views = 1582,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1583,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1584,                           /* -gvms */
  OPT_gxcoff = 1585,                         /* -gxcoff */
  OPT_gxcoff_ = 1586,                        /* -gxcoff+ */
  OPT_gz = 1587,                             /* -gz */
  OPT_gz_ = 1588,                            /* -gz= */
  OPT_h = 1589,                              /* -h */
  OPT_help = 1590,                           /* -help */
  OPT_idirafter = 1591,                      /* -idirafter */
  OPT_imacros = 1592,                        /* -imacros */
  OPT_imultiarch = 1593,                     /* -imultiarch */
  OPT_imultilib = 1594,                      /* -imultilib */
  OPT_include = 1595,                        /* -include */
  OPT_iplugindir_ = 1596,                    /* -iplugindir= */
  OPT_iprefix = 1597,                        /* -iprefix */
  OPT_iquote = 1598,                         /* -iquote */
  OPT_isysroot = 1599,                       /* -isysroot */
  OPT_isystem = 1600,                        /* -isystem */
  OPT_iwithprefix = 1601,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1602,              /* -iwithprefixbefore */
  OPT_k8 = 1603,                             /* -k8 */
  OPT_l = 1604,                              /* -l */
  OPT_lang_asm = 1605,                       /* -lang-asm */
  OPT_list = 1606,                           /* -list */
  OPT_mabi_ = 1607,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1608,             /* -mabort-on-noreturn */
  OPT_mandroid = 1609,                       /* -mandroid */
  OPT_mapcs = 1610,                          /* -mapcs */
  OPT_mapcs_frame = 1611,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1612,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1613,              /* -mapcs-stack-check */
  OPT_march_ = 1614,                         /* -march= */
  OPT_marm = 1615,                           /* -marm */
  OPT_masm_syntax_unified = 1616,            /* -masm-syntax-unified */
  OPT_mbe32 = 1617,                          /* -mbe32 */
  OPT_mbe8 = 1618,                           /* -mbe8 */
  OPT_mbig_endian = 1619,                    /* -mbig-endian */
  OPT_mbionic = 1620,                        /* -mbionic */
  OPT_mbranch_cost_ = 1621,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1622,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1623,     /* -mcaller-super-interworking */
  OPT_mcmse = 1624,                          /* -mcmse */
  OPT_mcpu_ = 1625,                          /* -mcpu= */
  OPT_mfdpic = 1626,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1627,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_m3_ldrd = 1628,            /* -mfix-cortex-m3-ldrd */
  OPT_mfix_vldstr = 1629,                    /* -mfix-vldstr */
  OPT_mflip_thumb = 1630,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1631,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1632,                  /* -mfp16-format= */
  OPT_mfpu_ = 1633,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1634,             /* -mgeneral-regs-only */
  OPT_mglibc = 1635,                         /* -mglibc */
  /* OPT_mhard_float = 1636, */              /* -mhard-float */
  OPT_mlibarch_ = 1637,                      /* -mlibarch= */
  OPT_mlittle_endian = 1638,                 /* -mlittle-endian */
  OPT_mlong_calls = 1639,                    /* -mlong-calls */
  OPT_mmusl = 1640,                          /* -mmusl */
  OPT_mneon_for_64bits = 1641,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1642,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1643,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1644,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1645,               /* -mprint-tune-info */
  OPT_mpure_code = 1646,                     /* -mpure-code */
  OPT_mrestrict_it = 1647,                   /* -mrestrict-it */
  OPT_msched_prolog = 1648,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1649,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1650,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1651, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1652,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1653,                         /* -mthumb */
  OPT_mthumb_interwork = 1654,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1655,                  /* -mtls-dialect= */
  OPT_mtp_ = 1656,                           /* -mtp= */
  OPT_mtpcs_frame = 1657,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1658,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1659,                         /* -mtune= */
  OPT_muclibc = 1660,                        /* -muclibc */
  OPT_munaligned_access = 1661,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1662,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1663,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1664,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1665,              /* -mword-relocations */
  OPT_n = 1666,                              /* -n */
  OPT_name_sort = 1667,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1668,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1669,              /* -no-integrated-cpp */
  OPT_no_pie = 1670,                         /* -no-pie */
  OPT_nocpp = 1671,                          /* -nocpp */
  OPT_nodefaultlibs = 1672,                  /* -nodefaultlibs */
  OPT_nolibc = 1673,                         /* -nolibc */
  OPT_nophoboslib = 1674,                    /* -nophoboslib */
  OPT_nostartfiles = 1675,                   /* -nostartfiles */
  OPT_nostdinc = 1676,                       /* -nostdinc */
  OPT_nostdinc__ = 1677,                     /* -nostdinc++ */
  OPT_nostdlib = 1678,                       /* -nostdlib */
  OPT_o = 1679,                              /* -o */
  OPT_objects = 1680,                        /* -objects */
  OPT_p = 1681,                              /* -p */
  OPT_pass_exit_codes = 1682,                /* -pass-exit-codes */
  /* OPT_pedantic = 1683, */                 /* -pedantic */
  OPT_pedantic_errors = 1684,                /* -pedantic-errors */
  OPT_pg = 1685,                             /* -pg */
  OPT_pie = 1686,                            /* -pie */
  OPT_pipe = 1687,                           /* -pipe */
  OPT_posix = 1688,                          /* -posix */
  OPT_print_file_name_ = 1689,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1690,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1691,          /* -print-multi-directory */
  OPT_print_multi_lib = 1692,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1693,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1694,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1695,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1696,               /* -print-prog-name= */
  OPT_print_search_dirs = 1697,              /* -print-search-dirs */
  OPT_print_sysroot = 1698,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1699,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1700,                    /* -print-value */
  OPT_profile = 1701,                        /* -profile */
  OPT_pthread = 1702,                        /* -pthread */
  OPT_quiet = 1703,                          /* -quiet */
  OPT_r = 1704,                              /* -r */
  OPT_rdynamic = 1705,                       /* -rdynamic */
  OPT_remap = 1706,                          /* -remap */
  OPT_reverse_sort = 1707,                   /* -reverse-sort */
  OPT_s = 1708,                              /* -s */
  OPT_save_temps = 1709,                     /* -save-temps */
  OPT_save_temps_ = 1710,                    /* -save-temps= */
  OPT_shared = 1711,                         /* -shared */
  OPT_shared_libgcc = 1712,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1713,               /* -shared-libphobos */
  OPT_size_sort = 1714,                      /* -size-sort */
  /* OPT_specs = 1715, */                    /* -specs */
  OPT_specs_ = 1716,                         /* -specs= */
  OPT_static = 1717,                         /* -static */
  OPT_static_libasan = 1718,                 /* -static-libasan */
  OPT_static_libgcc = 1719,                  /* -static-libgcc */
  OPT_static_libgfortran = 1720,             /* -static-libgfortran */
  OPT_static_libgo = 1721,                   /* -static-libgo */
  OPT_static_liblsan = 1722,                 /* -static-liblsan */
  OPT_static_libmpx = 1723,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1724,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1725,               /* -static-libphobos */
  OPT_static_libstdc__ = 1726,               /* -static-libstdc++ */
  OPT_static_libtsan = 1727,                 /* -static-libtsan */
  OPT_static_libubsan = 1728,                /* -static-libubsan */
  OPT_static_pie = 1729,                     /* -static-pie */
  /* OPT_std_c__03 = 1730, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1731, */                /* -std=c++0x */
  OPT_std_c__11 = 1732,                      /* -std=c++11 */
  OPT_std_c__14 = 1733,                      /* -std=c++14 */
  OPT_std_c__17 = 1734,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1735, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1736, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1737, */                /* -std=c++20 */
  OPT_std_c__2a = 1738,                      /* -std=c++2a */
  OPT_std_c__98 = 1739,                      /* -std=c++98 */
  OPT_std_c11 = 1740,                        /* -std=c11 */
  OPT_std_c17 = 1741,                        /* -std=c17 */
  /* OPT_std_c18 = 1742, */                  /* -std=c18 */
  /* OPT_std_c1x = 1743, */                  /* -std=c1x */
  OPT_std_c2x = 1744,                        /* -std=c2x */
  /* OPT_std_c89 = 1745, */                  /* -std=c89 */
  OPT_std_c90 = 1746,                        /* -std=c90 */
  OPT_std_c99 = 1747,                        /* -std=c99 */
  /* OPT_std_c9x = 1748, */                  /* -std=c9x */
  OPT_std_f2003 = 1749,                      /* -std=f2003 */
  OPT_std_f2008 = 1750,                      /* -std=f2008 */
  OPT_std_f2008ts = 1751,                    /* -std=f2008ts */
  OPT_std_f2018 = 1752,                      /* -std=f2018 */
  OPT_std_f95 = 1753,                        /* -std=f95 */
  OPT_std_gnu = 1754,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1755, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1756, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1757,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1758,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1759,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1760, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1761, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1762, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1763,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1764,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1765,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1766,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1767, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1768, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1769,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1770, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1771,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1772,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1773, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1774, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1775,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1776, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1777, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1778, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1779, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1780, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1781,                     /* -std=legacy */
  OPT_symbol_ = 1782,                        /* -symbol= */
  OPT_symbolic = 1783,                       /* -symbolic */
  OPT_t = 1784,                              /* -t */
  OPT_time = 1785,                           /* -time */
  OPT_time_ = 1786,                          /* -time= */
  OPT_tno_android_cc = 1787,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1788,                 /* -tno-android-ld */
  OPT_traditional = 1789,                    /* -traditional */
  OPT_traditional_cpp = 1790,                /* -traditional-cpp */
  OPT_tree_stats = 1791,                     /* -tree-stats */
  OPT_trigraphs = 1792,                      /* -trigraphs */
  OPT_type_stats = 1793,                     /* -type-stats */
  OPT_u = 1794,                              /* -u */
  OPT_undef = 1795,                          /* -undef */
  OPT_v = 1796,                              /* -v */
  OPT_version = 1797,                        /* -version */
  OPT_w = 1798,                              /* -w */
  OPT_wrapper = 1799,                        /* -wrapper */
  OPT_x = 1800,                              /* -x */
  OPT_z = 1801,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
